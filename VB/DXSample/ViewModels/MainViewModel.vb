...
Namespace DXSample.ViewModels
    ...
    Public Class MainViewModel
        ...
        Public Property SelectedEmployee As Employee
            Get
                Return GetProperty(Function() Me.SelectedEmployee)
            End Get
        ...
        Public Property Departments As ObservableCollection(Of EmployeeDepartment)
            Get
                Return GetProperty(Function() Me.Departments)
            End Get
        ...
        Public Sub New()
            Dim departments = DataHelper.GetEmployees().GroupBy(Function(x) x.GroupName).[Select](Function(x) CreateEmployeeDepartment(x.Key, x.Take(10).ToArray())).ToArray()
            Me.Departments = New ObservableCollection(Of EmployeeDepartment)(departments)
            SelectedEmployee = Me.Departments(0).Employees(0)
        End Sub
    ...
    Public Class Employee
        ...
        Public ReadOnly Property Image As ImageSource
            Get
                Return If(Equals(Gender, "F"), DataHelper.ImageFemale, DataHelper.ImageMale)
            End Get
        End Property
